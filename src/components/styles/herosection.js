  ...
  return (
    <>
      {/* <div classNameName="bg-white">
        <div classNameName="relative isolate">
          <div classNameName="mx-auto max-w-2xl py-20">
            <div classNameName="hidden sm:mb-8 sm:flex sm:justify-center">
              <div classNameName="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <div classNameName="text-center">
              ...
              <div classNameName="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#"
                  classNameName="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                  Get started
                </a>
                <a
                  href="#"
                  classNameName="text-sm font-semibold leading-6 text-gray-900">
